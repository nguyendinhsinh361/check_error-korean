...
class Kind_D8_Service:
    ...
    def F8(self, kana_question, text_question):
        arr_error = []
    ...
    def G8(self, romaji_question, kana_question):
        arr_error = []
    ...
    def L8(self, answer, correct_answer):
        arr_error = []
    ...
    def T8(self, explain, answer, correct_answer, kana_answer, romanji_answer):
        arr_error = []
    ...
    def V8(self, explain_grammar, text_question):
        arr_error = []
    ...
    def run(self):
        ...
        arr_error = [
            ...
            self.F8(kind_data["kana_question"], kind_data["text_question"]),
            self.G8(kind_data["romaji_question"], kind_data["kana_question"]),
            self.H8(kind_data["mean_question"]),
            self.J8(kind_data["audio"], kind_data["text_question"]),
            self.L8(kind_data["answer"], kind_data["correct_answer"]),
            self.M8(kind_data["kana_answer"], kind_data["answer"]),
            self.N8(kind_data["romanji_answer"], kind_data["kana_answer"]),
            self.S8(kind_data["correct_answer"]),
            self.T8(kind_data["explain"], kind_data["answer"], kind_data["correct_answer"],
                    kind_data["kana_answer"], kind_data["romanji_answer"]),
            self.V8(kind_data["explain_grammar"], kind_data["text_question"]),
        ]
