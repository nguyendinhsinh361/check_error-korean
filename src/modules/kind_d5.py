...
class Kind_D5_Service:
    ...
    def J5(self, audio, text_question):
        arr_error = []
    ...
    def run(self):
        ...
        arr_error = [
            ...
            self.J5(kind_data["audio"], kind_data["text_question"]),
            ...
            self.S5(kind_data["correct_answer"]),
            self.T5(kind_data["explain"], kind_data["answer"], kind_data["correct_answer"],
